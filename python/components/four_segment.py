...
def run_4_segment(settings, threads, stop_event):
    ...
    if settings["simulated"]:
        ...
        four_segment_thread = threading.Thread(target=run_4_segment_simulator, args=(alarm_time, turn_off, 10, stop_event, settings['name'], settings['runsOn']))
        ...
        four_thread = threading.Thread(target=run_display_loop, args=(alarm_time, turn_off, 10, four_segment, stop_event, settings['name'], settings['runsOn']))
        four_thread.start()
